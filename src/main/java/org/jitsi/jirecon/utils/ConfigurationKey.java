...
public class ConfigurationKey
{
    ...
    /**
     * The domain name of XMPP server, it's used for connecting with XMPP server.
     */
    public final static String XMPP_DOMAIN_KEY = PREFIX + ".XMPP_DOMAIN";
    ...
    /**
     * The hostname of <tt>Jirecon</tt> when join the MUC.
     */
    public final static String DOMAIN_KEY = PREFIX + ".JIRECON_DOMAIN";
