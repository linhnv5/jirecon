...
public class JinglePacketParser
{
    ...
    public static MediaType[] getSupportedMediaTypes(JingleIQ jiq)
    {
        ...
        for (int i = 0; i < mediaTypes.length; i++)
            mediaTypes[i] = MediaType.parseString(jiq.getContentList().get(i).getName());
     ...
     *         packet was found.
     */
    private static List<PayloadTypePacketExtension> getPayloadTypePacketExts(RtpDescriptionPacketExtension description)
    {
     ...
     *         packet was found.
     */
    private static List<PayloadTypePacketExtension> getPayloadTypePacketExts(JingleIQ jiq, MediaType mediaType)
    {
     ...
     *         found.
     */
    private static RtpDescriptionPacketExtension getDescriptionPacketExt(JingleIQ jiq, MediaType mediaType)
    {
